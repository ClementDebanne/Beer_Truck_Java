...
public class Conf {
    ...
    public static final String DB_NAME = getEnv("DISCODING_DB_NAME", "beer_truck");
    public static final String DB_URL = "jdbc:mysql://" + DB_HOST + "/" + DB_NAME + "?serverTimezone=Europe/Paris";
    public static final String DB_USER = getEnv("DISCODING_DB_USER", "beer_truck");
    public static final String DB_PASSWORD = getEnv("DISCODING_DB_PASSWORD", "beer_truck");
